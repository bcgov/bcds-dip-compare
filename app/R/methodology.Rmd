...
- For a single survey variable there may be multiple DIP variables that are related; in some cases, there may be 'no such variable' in addition to a valid DIP variable. In these cases, the valid DIP variable may only be partially comparable.
